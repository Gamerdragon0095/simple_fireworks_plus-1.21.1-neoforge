...
public class NBTTimerLoop {
    public static void createNewTimerTag(Entity entity, String name, int ticks, Boolean paused) {
        if (entity == null)
            return;

        String timerTag = "ticks:[" + ticks + "]" + " ,isPaused:[" + paused + "]";
    ...
    public static void setTicksOfTimerTag(Entity entity, String name, int ticks) {
        ...
        if(entity.getPersistentData().getString("" + name).length() >= 1) {
            ...
            if (timerLoopsTag.substring(12).contains(name)) {
                ...
                String newTag = "ticks:[" + ticks + "]" + " ,isPaused:[" + (oldTag.substring((int) index1, (int) index2)) + "]";
    ...
    public static void setIsPausedOfTimerTag(Entity entity, String name, boolean paused) {
        ...
        if(entity.getPersistentData().getString("" + name).length() >= 1) {
            ...
            if (timerLoopsTag.substring(12).contains(name)) {
                ...
                String newTag = "ticks:[" + (oldTag.substring((int) index1, (int) index2)) + "]" + " ,isPaused:[" + paused + "]";
